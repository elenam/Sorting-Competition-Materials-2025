...
public class Group4 {
	...
	public static void mergeSort(String[] array, SortingCompetitionComparator comparator)
	{
		if(array.length < 2)
		{
			return;
	...
	public static void merge(String[] array, String[] left, String[] right, SortingCompetitionComparator comparator)
	{
		int i = 0;
		int j = 0;
		int k = 0;
